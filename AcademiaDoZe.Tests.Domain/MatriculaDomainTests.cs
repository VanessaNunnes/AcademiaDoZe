...
//			var aluno = Aluno.Criar(1, "João", "123456789", new DateOnly(2000, 1, 1),
//										"joao@email.com", "48999999999", logradouro, "senha123",
//										null, "100", null);

//			var matricula = Matricula.Criar(id, aluno, EMatriculaPlano.Mensal,
...
//		{
//			var logradouro = Logradouro.Criar(1, "Rua A", "12345678", "Brasil", "SP", "SP", "Centro");
//			var aluno = Aluno.Criar(1, "João", "123456789", DateOnly.FromDateTime(DateTime.Now.AddYears(-10)),
//										"joao@email.com", "48999999999", logradouro, "senha123",
//										null, "100", null);

//			Assert.Throws<DomainException>(() =>
//				Matricula.Criar(id, aluno, EMatriculaPlano.Mensal,
//								DateOnly.FromDateTime(DateTime.Now),
//								DateOnly.FromDateTime(DateTime.Now.AddMonths(1)),
//								"Musculação", EMatriculaRestricoes.None, null)
//			);
