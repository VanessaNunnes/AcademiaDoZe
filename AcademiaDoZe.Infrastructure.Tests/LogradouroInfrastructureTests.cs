...
namespace AcademiaDoZe.Infrastructure.Tests
{
	public class LogradouroInfrastructureTests : TestBase
	{
		...
		public async Task Logradouro_Adicionar()
		{
			...
			var logradouro = Logradouro.Criar(1, "Rua dos Testes", _cep, "Bairro Teste", "SC", "TS", "Pais teste");
		...
		public async Task Logradouro_ObterPorCep_Atualizar()
		{
			...
			// Atualizar
			var logradouroAtualizado = Logradouro.Criar(1, "Rua Atualizada", _cep, "Bairro Teste Att", "AT", "TS", "Pais testeAtt");
